...
/**
 * Create a static file request handler for the given directory.
 * @param {string} dirPath - Absolute path to the directory to serve
 * @returns {function} (req, res) request handler
 */
function createStaticHandler (dirPath) {
...
function runCLI () {
  ...
  (async () => {
    ...
    const server = https.createServer(options, createStaticHandler(dirPath));
